...
consistent_Y_fix:
    ...
    fneg f12, f12
skip:
    lfs f7, -0x5818(r5) # Original instruction that was replaced by the jump
    blr # Return to game code (bl and blr should be safe to use, as the game soon does other bl-s anyway)
